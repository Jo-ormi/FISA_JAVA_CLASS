...
public class Basic2integerType {
	...
	public static void main(String[] args) {
		...
		// 왼쪽 부터 담을 수 있는 값의 크기가 작음
		
		byte a = 127; //허용 범위: -128 ~ 127, 2의 8제곱(256)
		short b = -32768; // 허용 범위: - 32768 ~ 32767
		int c = 0; //허용 범위: 약 20억, 정수형을 사용할 때 주로 사용하는 기본 타입
//		long d = 20000000000; // 허용 범위: 2의 약 63제곱
		// -> int가 정수형에서 기본 타입으로 사용되기 때문에 작성한 200억은 int로 인식되지만,
		// int의 값을 벗어났기 때문에 에러 발생
		long d = 20000000000L;
		
		long e = 20_000_000_000L; //JAVA 7 버전 부터 리터럴 중간에 구분자 _(언더바) 작성 가능
