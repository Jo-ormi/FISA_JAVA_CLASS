...
public class BasicTypeCasting {
	...
	public static void main(String[] args) {
		// 값의 허용 범위에 따른 값의 ㅈ ㅓ장
		byte a = 120;
		int b = 120;
		long c = 120; 
		// 120은 현재 int타입인데 변수 c의 long타입이 int타입보다 허용 범위가 넓기 때문에 저장가능
		
		double d = 5.5f;
		// 5.5f은 현재 float타입인데 변수 c의 double타입이 float타입보다 허용 범위가 넓기 때문에 저장가능
		
		// 정리하면, 어떤 타입의 허용 범위가 작은 타입에서 큰 타입으로는 값 저장이 가능
		
		byte e = (byte) 130;
		// 허용 범위보다 더 큰 값을 값이 손실되던 말던 집어 넣고 싶은 경우는?
		// (원하는 타입) 값
		System.out.println(e); // 이상한 값 -> 오버 플로우 발생
