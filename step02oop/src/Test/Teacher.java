...
public class Teacher {
	...
	public Teacher(String name, byte age, String gender, double height, double weight, String address,
			String university, int career, int payPerHour, String bestPart, boolean isWorking) {
		super();
		this.name = name;
		this.age = age;
		this.gender = gender;
	...
	public void matching(int wantAge, String gender, String wantSubject, String wantAddress, int payPerHour) {
		...
		if (total >= 60) {
			System.out.printf("%d 점수로 매칭되었습니다", total);
		} else {
			System.out.println(total + "점수로 매칭되지 않았습니다");
		}
	}
